...
<body>
    <h1 class = "text-center"> Weather Website Template </h1>
    <div class="container-fluid">
        <div class="row">
            <div class = "col-6">
                <a href = "forecast.php" class = "d-flex justify-content-center fs-1"> Forecast </a>
                <div id='map'></div>
            </div>
            <div class = "col-6">
                <h2 class = "text-center"> What is this website?</h2>
                <p class = "fs-5"> This website was originally used to research how to implement features  into the final assessment website we were tasked to make for a Digital T Level course. Since finishing the course, I have fleshed it out further into a full weather forecast website, air quality forecast, placeholder articles and other features. <br> This website was made primarily using PHP, with weather API's such and openweathermap and tomorrow.io.</P>
            </div>
        </div>
    </div>
</body>
